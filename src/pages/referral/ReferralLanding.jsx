...
const ReferralLanding = () => {
  ...
  return (
    <div className='flex w-full h-screen overflow-hidden'>
        ...
        <div className='w-6/12 flex flex-col items-center relative justify-center gap-[23px] px-10'>  
            ...
            <div className='w-full flex flex-col items-center justify-center gap-[43px]'>
                ...
                >
                    <p className='text-[#FFFCF7] font-sen font-bold text-[24px]'>Refer a Friend</p>
                </button>
